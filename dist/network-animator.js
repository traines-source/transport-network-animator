...
var ___EXPOSE_LOADER_IMPORT___ = __webpack_require__(/*! -!../../node_modules/ts-loader/index.js??ruleSet[1].rules[0].use[1]!./CrumpledImage.ts */ "./node_modules/ts-loader/index.js??ruleSet[1].rules[0].use[1]!./src/drawables/CrumpledImage.ts");
var ___EXPOSE_LOADER_GET_GLOBAL_THIS___ = __webpack_require__(/*! ../../node_modules/expose-loader/dist/runtime/getGlobalThis.js */ "./node_modules/expose-loader/dist/runtime/getGlobalThis.js");
var ___EXPOSE_LOADER_GLOBAL_THIS___ = ___EXPOSE_LOADER_GET_GLOBAL_THIS___;
___EXPOSE_LOADER_GLOBAL_THIS___["TNA"] = ___EXPOSE_LOADER_IMPORT___;
module.exports = ___EXPOSE_LOADER_IMPORT___;
...
var ___EXPOSE_LOADER_IMPORT___ = __webpack_require__(/*! -!../../node_modules/ts-loader/index.js??ruleSet[1].rules[0].use[1]!./KenImage.ts */ "./node_modules/ts-loader/index.js??ruleSet[1].rules[0].use[1]!./src/drawables/KenImage.ts");
var ___EXPOSE_LOADER_GET_GLOBAL_THIS___ = __webpack_require__(/*! ../../node_modules/expose-loader/dist/runtime/getGlobalThis.js */ "./node_modules/expose-loader/dist/runtime/getGlobalThis.js");
var ___EXPOSE_LOADER_GLOBAL_THIS___ = ___EXPOSE_LOADER_GET_GLOBAL_THIS___;
___EXPOSE_LOADER_GLOBAL_THIS___["TNA"] = ___EXPOSE_LOADER_IMPORT___;
module.exports = ___EXPOSE_LOADER_IMPORT___;
...
var ___EXPOSE_LOADER_IMPORT___ = __webpack_require__(/*! -!../../node_modules/ts-loader/index.js??ruleSet[1].rules[0].use[1]!./SvgCrumpledImage.ts */ "./node_modules/ts-loader/index.js??ruleSet[1].rules[0].use[1]!./src/svg/SvgCrumpledImage.ts");
var ___EXPOSE_LOADER_GET_GLOBAL_THIS___ = __webpack_require__(/*! ../../node_modules/expose-loader/dist/runtime/getGlobalThis.js */ "./node_modules/expose-loader/dist/runtime/getGlobalThis.js");
var ___EXPOSE_LOADER_GLOBAL_THIS___ = ___EXPOSE_LOADER_GET_GLOBAL_THIS___;
___EXPOSE_LOADER_GLOBAL_THIS___["TNA"] = ___EXPOSE_LOADER_IMPORT___;
module.exports = ___EXPOSE_LOADER_IMPORT___;
...
var ___EXPOSE_LOADER_IMPORT___ = __webpack_require__(/*! -!../../node_modules/ts-loader/index.js??ruleSet[1].rules[0].use[1]!./SvgKenImage.ts */ "./node_modules/ts-loader/index.js??ruleSet[1].rules[0].use[1]!./src/svg/SvgKenImage.ts");
var ___EXPOSE_LOADER_GET_GLOBAL_THIS___ = __webpack_require__(/*! ../../node_modules/expose-loader/dist/runtime/getGlobalThis.js */ "./node_modules/expose-loader/dist/runtime/getGlobalThis.js");
var ___EXPOSE_LOADER_GLOBAL_THIS___ = ___EXPOSE_LOADER_GET_GLOBAL_THIS___;
___EXPOSE_LOADER_GLOBAL_THIS___["TNA"] = ___EXPOSE_LOADER_IMPORT___;
module.exports = ___EXPOSE_LOADER_IMPORT___;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.ArrivalDepartureTime = void 0;
...
exports.ArrivalDepartureTime = ArrivalDepartureTime;
...
class BoundingBox {
    ...
    static from(tl_x, tl_y, br_x, br_y) {
        return new BoundingBox(new Vector_1.Vector(tl_x, tl_y), new Vector_1.Vector(br_x, br_y));
    }
    get dimensions() {
        return this.tl.delta(this.br);
    }
    isNull() {
        return this.tl == Vector_1.Vector.NULL || this.br == Vector_1.Vector.NULL;
    }
    calculateBoundingBoxForZoom(percentX, percentY) {
        const bbox = this;
        const delta = bbox.dimensions;
        const relativeCenter = new Vector_1.Vector(percentX / 100, percentY / 100);
        const center = bbox.tl.add(new Vector_1.Vector(delta.x * relativeCenter.x, delta.y * relativeCenter.y));
        const edgeDistance = new Vector_1.Vector(delta.x * Math.min(relativeCenter.x, 1 - relativeCenter.x), delta.y * Math.min(relativeCenter.y, 1 - relativeCenter.y));
        const ratioPreservingEdgeDistance = new Vector_1.Vector(edgeDistance.y * delta.x / delta.y, edgeDistance.x * delta.y / delta.x);
        const minimalEdgeDistance = new Vector_1.Vector(Math.min(edgeDistance.x, ratioPreservingEdgeDistance.x), Math.min(edgeDistance.y, ratioPreservingEdgeDistance.y));
        return new BoundingBox(center.add(new Vector_1.Vector(-minimalEdgeDistance.x, -minimalEdgeDistance.y)), center.add(minimalEdgeDistance));
    }
    add(...coords) {
...
class Config {
    constructor() {
         ...
         */
        this.gravitatorUseInclinationInertness = true;
        /**
         ...
         */
        this.gravitatorGradientScale = 0.01;
        /**
...
const Line_1 = __webpack_require__(/*! ./drawables/Line */ "./src/drawables/Line.ts");
const Vector_1 = __webpack_require__(/*! ./Vector */ "./src/Vector.ts");
class DrawableSorter {
    ...
    sort(elements, draw, animate) {
        ...
        if (representativeElement instanceof Line_1.Line && representativeElement.animOrder != undefined) {
    ...
    buildSortableCache(elements, direction) {
        ...
        for (let i = 0; i < elements.length; i++) {
            if (elements[i] instanceof Line_1.Line) {
                const element = elements[i];
                let termini = [Vector_1.Vector.NULL, Vector_1.Vector.NULL];
...
exports.DrawableSorter = DrawableSorter;
...
class Gravitator {
    ...
    gravitate(delay, animate) {
        ...
        console.log("Time taken for optimization:", performance.now() - startTime, "(incl: " + Config_1.Config.default.gravitatorUseInclinationInertness + ")");
    ...
    initialize() {
        ...
        if (this.averageEuclidianLengthRatio == -1 && edgeCount > 0) {
            ...
            (_a = this.crumpledImage) === null || _a === void 0 ? void 0 : _a.initialize(Object.values(this.vertices).map(v => v.station));
        }
    }
    getWeightsSum() {
        let sum = 0;
    ...
    initializeGraph() {
        for (const [key, edge] of Object.entries(this.edges)) {
            if (this.initialWeightFactors[key] == undefined) {
                this.initialWeightFactors[key] = Config_1.Config.default.gravitatorInitializeRelativeToEuclidianDistance
        ...
        for (const vertex of Object.values(this.vertices)) {
            vertex.index = new Vector_1.Vector(i, i + 1);
            i += 2;
        }
    }
    minimizeLoss() {
        ...
        const solution = fmin.conjugateGradient((A, fxprime) => {
            ...
            let fx = 0;
            if (Config_1.Config.default.gravitatorUseInclinationInertness) {
    ...
    deltaToPreviousStationPositionsToEnsureInertness(fx, A, fxprime, useStartPosition) {
        for (const vertex of Object.values(this.vertices)) {
            ...
            fx += (Math.pow(A[vertex.index.x] - vector.x, 2) +
                Math.pow(A[vertex.index.y] - vector.y, 2)) * c * Config_1.Config.default.gravitatorInertness;
            fxprime[vertex.index.x] += 2 * (A[vertex.index.x] - vector.x) * c * Config_1.Config.default.gravitatorInertness;
            fxprime[vertex.index.y] += 2 * (A[vertex.index.y] - vector.y) * c * Config_1.Config.default.gravitatorInertness;
        }
        return fx;
    }
    deltaToInclinationToEnsureInertness(fx, A, fxprime) {
        for (const [key, e] of Object.entries(this.edges)) {
            ...
            fx += (Math.pow(normXDelta, 2) +
                Math.pow(normYDelta, 2)) * Config_1.Config.default.gravitatorInertness;
            ...
            const c = 2 * Config_1.Config.default.gravitatorInertness;
    ...
    deltaToNewDistancesToEnsureAccuracy(fx, A, fxprime) {
        for (const [key, e] of Object.entries(this.edges)) {
            const edge = e.line;
            const f = 1;
            ...
            const v = (Math.pow(this.deltaX(A, this.vertices, edge.termini), 2) +
                Math.pow(this.deltaY(A, this.vertices, edge.termini), 2)) * c - f;
            fx += Math.pow(v, 2);
    ...
    scaleGradientToEnsureWorkingStepSize(fxprime) {
        for (let i = 0; i < fxprime.length; i++) {
            fxprime[i] *= Config_1.Config.default.gravitatorGradientScale;
        }
    }
    ...
    moveStationsAndLines(solution, delay, animate) {
        ...
        const animationDurationSeconds = animate
            ? Math.min(Config_1.Config.default.gravitatorAnimMaxDurationSeconds, this.getTotalDistanceToMove(solution) / Config_1.Config.default.gravitatorAnimSpeed)
            : 0;
        for (const vertex of Object.values(this.vertices)) {
            vertex.station.move(delay, animationDurationSeconds, new Vector_1.Vector(solution[vertex.index.x], solution[vertex.index.y]));
        }
        ...
        (_a = this.crumpledImage) === null || _a === void 0 ? void 0 : _a.crumple(delay, animationDurationSeconds);
    ...
    getColorByDeviation(edge, weight) {
        ...
        return Math.max(-1, Math.min(1, (weight - this.averageEuclidianLengthRatio * initialDist) * Config_1.Config.default.gravitatorColorDeviation));
    }
    getTotalDistanceToMove(solution) {
        let sum = 0;
        for (const vertex of Object.values(this.vertices)) {
            sum += new Vector_1.Vector(solution[vertex.index.x], solution[vertex.index.y]).delta(vertex.station.baseCoords).length;
        }
        return sum;
    }
    getNewStationPosition(stationId, solution) {
        return new Vector_1.Vector(solution[this.vertices[stationId].index.x], solution[this.vertices[stationId].index.y]);
    }
    addVertex(vertexId, stationProvider) {
        if (this.vertices[vertexId] == undefined) {
            ...
            this.vertices[vertexId] = { station: station, index: Vector_1.Vector.NULL, startCoords: station.baseCoords };
        }
    }
    startEdgeInclination(line) {
        ...
        return new Vector_1.Vector(deltaXStart * normStart, deltaYStart * normStart);
    }
    addEdge(line, stationProvider) {
    ...
    setIfCrumpledImage(element) {
        if (element instanceof CrumpledImage_1.CrumpledImage) {
    ...
    getIdentifier(line) {
        return Utils_1.Utils.alphabeticId(line.termini[0].stationId, line.termini[1].stationId);
    }
}
exports.Gravitator = Gravitator;
...
class LineGroup {
    ...
    getPathBetweenStops(line, from, to) {
        ...
        let fromIdx = this.indexOf(path, from.coord || Vector_1.Vector.NULL);
        let toIdx = this.indexOf(path, to.coord || Vector_1.Vector.NULL);
    ...
    updateTermini() {
        ...
        for (const [stationId, occurences] of Object.entries(candidates)) {
            if (occurences == 1) {
                termini.push(new Station_1.Stop(stationId, ''));
            }
        }
...
class Network {
    ...
    lineGroupById(id) {
        if (this.lineGroups[id] == undefined) {
            this.lineGroups[id] = new LineGroup_1.LineGroup();
        }
    ...
    displayInstant(instant) {
        if (!instant.equals(Instant_1.Instant.BIG_BANG)) {
    ...
    drawTimedDrawablesAt(now, animate) {
        ...
        let delay = Config_1.Config.default.zoomDuration;
        for (let i = 0; i < elements.length; i++) {
    ...
    isDrawableEliglibleForSameBuffer(element, now) {
        ...
        if (element instanceof Line_1.Line && lastElement instanceof Line_1.Line && ((_a = element.animOrder) === null || _a === void 0 ? void 0 : _a.degrees) != ((_b = lastElement.animOrder) === null || _b === void 0 ? void 0 : _b.degrees)) {
            return false;
        }
        return true;
    }
    ...
    drawElement(element, delay, animate, reverse) {
        if (element instanceof Line_1.Line) {
    ...
    addToIndex(element) {
        ...
        if (!Instant_1.Instant.BIG_BANG.equals(element.to))
            this.setSlideIndexElement(element.to, element);
        if (element instanceof Station_1.Station) {
    ...
    nextInstant(now) {
        ...
        return new Instant_1.Instant(epoch, second, '');
    }
...
exports.PreferredTrack = PreferredTrack;
...
class Projection {
     ...
     */
    static get default() {
        return this._default || (this._default = new Projection(Config_1.Config.default.mapProjection));
    }
    /**
     ...
     */
    project(coords) {
        return Projection.projections[this._projection](coords).scale(Config_1.Config.default.mapProjectionScale).round(1);
    }
}
...
Projection.projections = {
    'epsg3857': lonlat => new Vector_1.Vector(256 / Math.PI * (lonlat.x / 180 * Math.PI + Math.PI), 256 / Math.PI * (Math.PI - Math.log(Math.tan(Math.PI / 4 + lonlat.y / 180 * Math.PI / 2))))
};
...
class Rotation {
    ...
    get name() {
        for (const [key, value] of Object.entries(Rotation.DIRS)) {
            if (Utils_1.Utils.equals(value, this.degrees)) {
                return key;
            }
        }
        return 'n';
    ...
    normalize() {
        ...
        if (Utils_1.Utils.equals(dir, -90))
            dir = 0;
        else if (dir < -90)
            dir += 180;
        else if (dir > 90)
...
class Vector {
    ...
    isDeltaMatchingParallel(dir1, dir2) {
        ...
        return Utils_1.Utils.equals(a % 180, 0) && Utils_1.Utils.equals(b % 180, 0);
    }
    inclination() {
        if (Utils_1.Utils.equals(this.x, 0))
            return new Rotation_1.Rotation(this.y > 0 ? 180 : 0);
        if (Utils_1.Utils.equals(this.y, 0))
            return new Rotation_1.Rotation(this.x > 0 ? 90 : -90);
        const adjacent = new Vector(0, -Math.abs(this.y));
        return new Rotation_1.Rotation(Math.sign(this.x) * Math.acos(this.dotProduct(adjacent) / adjacent.length / this.length) * 180 / Math.PI);
    }
    angle(other) {
...
class Zoomer {
    constructor(canvasSize, zoomMaxScale = 3) {
        ...
        this.boundingBox = new BoundingBox_1.BoundingBox(Vector_1.Vector.NULL, Vector_1.Vector.NULL);
    ...
    enforcedBoundingBox() {
        if (!this.boundingBox.isNull()) {
            ...
            const minZoomSize = new Vector_1.Vector(canvasSize.x / this.zoomMaxScale, canvasSize.y / this.zoomMaxScale);
            const delta = zoomSize.delta(minZoomSize);
            const additionalSpacing = new Vector_1.Vector(Math.max(0, delta.x / 2), Math.max(0, delta.y / 2));
            return new BoundingBox_1.BoundingBox(paddedBoundingBox.tl.add(additionalSpacing.rotate(new Rotation_1.Rotation(180))), paddedBoundingBox.br.add(additionalSpacing));
        }
        return this.boundingBox;
    }
    paddedBoundingBox(boundingBox) {
        const padding = Config_1.Config.default.zoomPaddingFactor * Math.min(this.zoomMaxScale, 8);
        return new BoundingBox_1.BoundingBox(boundingBox.tl.add(new Vector_1.Vector(-padding, -padding)), boundingBox.br.add(new Vector_1.Vector(padding, padding)));
    }
    get center() {
        const enforcedBoundingBox = this.enforcedBoundingBox();
        if (!enforcedBoundingBox.isNull()) {
            return new Vector_1.Vector(Math.round((enforcedBoundingBox.tl.x + enforcedBoundingBox.br.x) / 2), Math.round((enforcedBoundingBox.tl.y + enforcedBoundingBox.br.y) / 2));
        }
    ...
    get duration() {
        if (this.customDuration == -1) {
            return Config_1.Config.default.zoomDuration;
        }
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.AbstractTimedDrawable = void 0;
...
exports.AbstractTimedDrawable = AbstractTimedDrawable;


/***/ }),

/***/ "./node_modules/ts-loader/index.js??ruleSet[1].rules[0].use[1]!./src/drawables/CrumpledImage.ts":
/*!******************************************************************************************************!*\
  !*** ./node_modules/ts-loader/index.js??ruleSet[1].rules[0].use[1]!./src/drawables/CrumpledImage.ts ***!
  \******************************************************************************************************/
...
class CrumpledImage extends AbstractTimedDrawable_1.AbstractTimedDrawable {
    ...
    getDelaunator() {
        return delaunator_1.default.from(this.vertices, n => n.startCoords.x, n => n.startCoords.y);
    }
    getCanvasSides() {
        const tl = this.adapter.boundingBox.tl;
        const br = this.adapter.boundingBox.br;
        const tr = new Vector_1.Vector(br.x, tl.y);
        const bl = new Vector_1.Vector(tl.x, br.y);
        const t = new Vector_1.Vector(tr.x - tl.x, 0);
        const r = new Vector_1.Vector(0, br.y - tr.y);
        const b = new Vector_1.Vector(bl.x - br.x, 0);
        const l = new Vector_1.Vector(0, tl.y - bl.y);
        return [
            { corner: tl, side: t },
            { corner: tr, side: r },
            { corner: br, side: b },
    ...
    setVerticesExtendedToCanvasBoundaries(triangles, halfEdges) {
    ...
    factorToExtendVectorToCanvasBoundaries(origin, extend) {
    ...
    extendCurrentVector(origin, direction, factor) {
    ...
    crumple(delay, animationDurationSeconds) {
...
CrumpledImage.EXTEND_BEYOND_CANVAS_FACTOR = 2;
...
exports.GenericTimedDrawable = GenericTimedDrawable;


/***/ }),

/***/ "./node_modules/ts-loader/index.js??ruleSet[1].rules[0].use[1]!./src/drawables/KenImage.ts":
/*!*************************************************************************************************!*\
  !*** ./node_modules/ts-loader/index.js??ruleSet[1].rules[0].use[1]!./src/drawables/KenImage.ts ***!
  \*************************************************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
class KenImage extends AbstractTimedDrawable_1.AbstractTimedDrawable {
    ...
    draw(delay, animate) {
        const zoomer = new Zoomer_1.Zoomer(this.boundingBox);
        zoomer.include(this.getZoomedBoundingBox(), Instant_1.Instant.BIG_BANG, Instant_1.Instant.BIG_BANG, true, true, false);
    ...
    getZoomedBoundingBox() {
        ...
        if (center != Vector_1.Vector.NULL) {
...
class Label extends AbstractTimedDrawable_1.AbstractTimedDrawable {
    ...
    draw(delay, animate) {
        if (this.adapter.forStation != undefined) {
            ...
            this.adapter.draw(delay, Vector_1.Vector.NULL, Rotation_1.Rotation.from('n'), []);
        }
        return 0;
    }
    drawForStation(delaySeconds, station, forLine) {
        ...
        for (let i = 0; i < station.labels.length; i++) {
            ...
            if (l == this)
                break;
            yOffset += Config_1.Config.default.labelHeight * 1.5;
        }
        const labelDir = station.labelDir;
        yOffset = Math.sign(Vector_1.Vector.UNIT.rotate(labelDir).y) * yOffset - (yOffset > 0 ? 2 : 0); //TODO magic numbers
        const stationDir = station.rotation;
        const diffDir = labelDir.add(new Rotation_1.Rotation(-stationDir.degrees));
        const unitv = Vector_1.Vector.UNIT.rotate(diffDir);
        const anchor = new Vector_1.Vector(station.stationSizeForAxis('x', unitv.x), station.stationSizeForAxis('y', unitv.y));
        const textCoords = baseCoord.add(anchor.rotate(stationDir)).add(new Vector_1.Vector(0, yOffset));
...
class Line extends AbstractTimedDrawable_1.AbstractTimedDrawable {
    ...
    erase(delay, animate, reverse) {
        ...
        for (let j = 0; j < stops.length; j++) {
            ...
            if (j > 0) {
                const helpStopId = 'h_' + Utils_1.Utils.alphabeticId(stops[j - 1].stationId, stops[j].stationId);
    ...
    createLine(delay, animate) {
        ...
        let track = new PreferredTrack_1.PreferredTrack('+');
        for (let j = 0; j < stops.length; j++) {
    ...
    createConnection(station, nextStopBaseCoord, track, path, delay, animate, recurse) {
        ...
        if (path.length != 0) {
            ...
            if (!found && recurse && this.precedingStop != undefined) {
                ...
                this.precedingDir = this.precedingDir.add(new Rotation_1.Rotation(180));
    ...
    getStopOrientationBasedOnThreeStops(station, nextStopBaseCoord, dir, path) {
        ...
        if (existingAxis != undefined) {
            const existingStopOrientiation = delta.inclination().halfDirection(dir, existingAxis == 'x' ? new Rotation_1.Rotation(90) : new Rotation_1.Rotation(0));
            if (this.precedingDir == undefined) {
                this.precedingDir = existingStopOrientiation.add(dir).add(new Rotation_1.Rotation(180));
            }
    ...
    getPrecedingDir(precedingDir, precedingStop, oldCoord, newCoord) {
        ...
        if (precedingDir == undefined) {
            const precedingStopRotation = (_a = precedingStop === null || precedingStop === void 0 ? void 0 : precedingStop.rotation) !== null && _a !== void 0 ? _a : new Rotation_1.Rotation(0);
            precedingDir = oldCoord.delta(newCoord).inclination().quarterDirection(precedingStopRotation).add(precedingStopRotation);
        }
        else {
            precedingDir = precedingDir.add(new Rotation_1.Rotation(180));
        }
        return precedingDir;
    }
    insertNode(fromCoord, fromDir, toCoord, toDir, path) {
        ...
        const oldDirV = Vector_1.Vector.UNIT.rotate(fromDir);
        const newDirV = Vector_1.Vector.UNIT.rotate(toDir);
        if (delta.isDeltaMatchingParallel(oldDirV, newDirV)) {
            return true;
        }
        const solution = delta.solveDeltaForIntersection(oldDirV, newDirV);
        if (solution.a > Config_1.Config.default.minNodeDistance && solution.b > Config_1.Config.default.minNodeDistance) {
            path.push(new Vector_1.Vector(fromCoord.x + oldDirV.x * solution.a, fromCoord.y + oldDirV.y * solution.a));
            return true;
        }
        return false;
    }
    getOrCreateHelperStop(fromDir, fromStop, toStop) {
        const helpStopId = 'h_' + Utils_1.Utils.alphabeticId(fromStop.id, toStop.id);
        let helpStop = this.stationProvider.stationById(helpStopId);
        if (helpStop == undefined) {
    ...
    get speed() {
        return this.adapter.speed || Config_1.Config.default.animSpeed;
    }
...
exports.Stop = Stop;
class Station extends AbstractTimedDrawable_1.AbstractTimedDrawable {
    constructor(adapter) {
        super(adapter);
        this.adapter = adapter;
        ...
        if (this.adapter.lonLat != undefined) {
            this.adapter.baseCoords = Projection_1.Projection.default.project(this.adapter.lonLat);
        }
    }
    get baseCoords() {
    ...
    get boundingBox() {
        return new BoundingBox_1.BoundingBox(this.adapter.baseCoords, this.adapter.baseCoords);
    }
    ...
    rotatedTrackCoordinates(incomingDir, assignedTrack) {
        ...
        if (incomingDir.degrees % 180 == 0) {
            newCoord = new Vector_1.Vector(assignedTrack * Config_1.Config.default.lineDistance, 0);
        }
        else {
            newCoord = new Vector_1.Vector(0, assignedTrack * Config_1.Config.default.lineDistance);
        }
    ...
    stationSizeForAxis(axis, vector) {
        if (Utils_1.Utils.equals(vector, 0))
            return 0;
        ...
        return dimen * Config_1.Config.default.lineDistance + dir * (Config_1.Config.default.defaultStationDimen + Config_1.Config.default.labelDistance);
    }
    linesExisting() {
...
class Train extends AbstractTimedDrawable_1.AbstractTimedDrawable {
    ...
    draw(delay, animate) {
        ...
        for (let i = 1; i < stops.length; i++) {
            const arrdep = new ArrivalDepartureTime_1.ArrivalDepartureTime(stops[i].trackInfo);
...
if (Config_1.Config.default.autoStart) {
    started = true;
...
function startTransportNetworkAnimator() {
    network.initialize();
    slide(Instant_1.Instant.BIG_BANG, false);
}
function getStartInstant() {
    if (window.location.hash) {
        const animateFromInstant = window.location.hash.replace('#', '').split('-');
        const instant = new Instant_1.Instant(parseInt(animateFromInstant[0]) || 0, parseFloat(animateFromInstant[1]) || 0, '');
        stopped = animateFromInstant[2] == 'stop';
        console.log('fast forward to', instant);
        return instant;
    }
    return Instant_1.Instant.BIG_BANG;
}
function slide(instant, animate) {
    if (instant != Instant_1.Instant.BIG_BANG && instant.epoch >= animateFromInstant.epoch && instant.second >= animateFromInstant.second)
        animate = true;
    ...
    if (!(stopped && animate) && next) {
        ...
        const animator = new SvgAnimator_1.SvgAnimator();
...
class SvgAbstractTimedDrawable {
    ...
    get boundingBox() {
        ...
        if (document.getElementById('zoomable') != undefined) {
            ...
            return new BoundingBox_1.BoundingBox(new Vector_1.Vector(x, y), new Vector_1.Vector(x + lRect.width * zScale, y + lRect.height * zScale));
        }
        return new BoundingBox_1.BoundingBox(new Vector_1.Vector(lBox.x, lBox.y), new Vector_1.Vector(lBox.x + lBox.width, lBox.y + lBox.height));
    }
    getInstant(fromOrTo) {
        var _a;
        if (this.element.dataset[fromOrTo] != undefined) {
            ...
            if (arr != undefined) {
                return Instant_1.Instant.from(arr);
            }
        }
        return Instant_1.Instant.BIG_BANG;
    }
}
exports.SvgAbstractTimedDrawable = SvgAbstractTimedDrawable;
...
exports.SvgAnimator = SvgAnimator;


/***/ }),

/***/ "./node_modules/ts-loader/index.js??ruleSet[1].rules[0].use[1]!./src/svg/SvgCrumpledImage.ts":
/*!***************************************************************************************************!*\
  !*** ./node_modules/ts-loader/index.js??ruleSet[1].rules[0].use[1]!./src/svg/SvgCrumpledImage.ts ***!
  \***************************************************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
class SvgCrumpledImage extends SvgAbstractTimedDrawable_1.SvgAbstractTimedDrawable {
    ...
    get boundingBox() {
        if (this.canvasBoundingBox == undefined) {
            ...
            this.canvasBoundingBox = new BoundingBox_1.BoundingBox(new Vector_1.Vector(r.x, r.y), new Vector_1.Vector(r.x + r.width, r.y + r.height));
        }
    ...
    setupImage() {
        ...
        this.img.onload = e => {
            ...
            ctx === null || ctx === void 0 ? void 0 : ctx.drawImage(this.img, 0, 0, this.boundingBox.dimensions.x, this.boundingBox.dimensions.y);
        };
        this.element.appendChild(this.img);
    }
    draw(delaySeconds, animationDurationSeconds, triangles) {
        const animator = new SvgAnimator_1.SvgAnimator();
    ...
    svg2ImgCoords(v) {
        ...
        return new Vector_1.Vector(relSvg.x * scaleX, relSvg.y * scaleY);
    }
    svg2CanvasCoords(v) {
...
exports.SvgCrumpledImage = SvgCrumpledImage;
...
exports.SvgGenericTimedDrawable = SvgGenericTimedDrawable;


/***/ }),

/***/ "./node_modules/ts-loader/index.js??ruleSet[1].rules[0].use[1]!./src/svg/SvgKenImage.ts":
/*!**********************************************************************************************!*\
  !*** ./node_modules/ts-loader/index.js??ruleSet[1].rules[0].use[1]!./src/svg/SvgKenImage.ts ***!
  \**********************************************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
class SvgKenImage extends SvgAbstractTimedDrawable_1.SvgAbstractTimedDrawable {
    ...
    get boundingBox() {
        const r = this.element.getBBox();
        return new BoundingBox_1.BoundingBox(new Vector_1.Vector(r.x, r.y), new Vector_1.Vector(r.x + r.width, r.y + r.height));
    }
    get zoom() {
        if (this.element.dataset['zoom'] != undefined) {
            const center = this.element.dataset['zoom'].split(' ');
            return new Vector_1.Vector(parseInt(center[0]) || 50, parseInt(center[1]) || 50);
        }
    ...
    animateFrame(x, isLast, fromCenter, toCenter, fromScale, toScale) {
        if (!isLast) {
            ...
            const center = new Vector_1.Vector(delta.x * x, delta.y * x).add(fromCenter);
...
exports.SvgKenImage = SvgKenImage;
...
class SvgLabel extends SvgAbstractTimedDrawable_1.SvgAbstractTimedDrawable {
    ...
    get boundingBox() {
        ...
        return new BoundingBox_1.BoundingBox(Vector_1.Vector.NULL, Vector_1.Vector.NULL);
    }
    draw(delaySeconds, textCoords, labelDir, children) {
        const animator = new SvgAnimator_1.SvgAnimator();
        animator.wait(delaySeconds * 1000, () => {
            if (textCoords != Vector_1.Vector.NULL) {
    ...
    translate(boxDimen, labelDir) {
        const labelunitv = Vector_1.Vector.UNIT.rotate(labelDir);
        this.element.style.transform = 'translate('
            + Utils_1.Utils.trilemma(labelunitv.x, [-boxDimen.x + 'px', -boxDimen.x / 2 + 'px', '0px'])
            + ','
            + Utils_1.Utils.trilemma(labelunitv.y, [-Config_1.Config.default.labelHeight + 'px', -Config_1.Config.default.labelHeight / 2 + 'px', '0px']) // TODO magic numbers
            + ')';
        this.element.style.visibility = 'visible';
    }
    drawLineLabels(labelDir, children) {
        ...
        this.translate(new Vector_1.Vector(bbox.width / scale, bbox.height / scale), labelDir);
    }
    drawLineLabel(label) {
    ...
    drawStationLabel(labelDir) {
        ...
        this.translate(new Vector_1.Vector(this.element.getBBox().width, this.element.getBBox().height), labelDir);
    }
    erase(delaySeconds) {
        const animator = new SvgAnimator_1.SvgAnimator();
        animator.wait(delaySeconds * 1000, () => {
...
class SvgLine extends SvgAbstractTimedDrawable_1.SvgAbstractTimedDrawable {
    constructor(element) {
        ...
        this.element = element;
        this._stops = [];
        this._boundingBox = new BoundingBox_1.BoundingBox(Vector_1.Vector.NULL, Vector_1.Vector.NULL);
    }
    get name() {
        return this.element.dataset.line || '';
    }
    ...
    get termini() {
        ...
        return SvgUtils_1.SvgUtils.readTermini(d || undefined);
    }
    get animOrder() {
        if (this.element.dataset.animOrder == undefined) {
            return undefined;
        }
        return Rotation_1.Rotation.from(this.element.dataset.animOrder);
    }
    get speed() {
...
const Label_1 = __webpack_require__(/*! ../drawables/Label */ "./src/drawables/Label.ts");
...
const Train_1 = __webpack_require__(/*! ../drawables/Train */ "./src/drawables/Train.ts");
...
class SvgNetwork {
    ...
    svgConfig() {
        ...
        if ((svg === null || svg === void 0 ? void 0 : svg.dataset.autoStart) != undefined) {
            Config_1.Config.default.autoStart = (svg === null || svg === void 0 ? void 0 : svg.dataset.autoStart) != 'false';
        }
        if ((svg === null || svg === void 0 ? void 0 : svg.dataset.zoomMaxScale) != undefined) {
            Config_1.Config.default.zoomMaxScale = parseFloat(svg === null || svg === void 0 ? void 0 : svg.dataset.zoomMaxScale);
        }
        if ((svg === null || svg === void 0 ? void 0 : svg.dataset.beckStyle) != undefined) {
            Config_1.Config.default.beckStyle = (svg === null || svg === void 0 ? void 0 : svg.dataset.beckStyle) != 'false';
        }
        if ((svg === null || svg === void 0 ? void 0 : svg.dataset.trainTimetableSpeed) != undefined) {
            Config_1.Config.default.trainTimetableSpeed = parseFloat(svg === null || svg === void 0 ? void 0 : svg.dataset.trainTimetableSpeed);
        }
    }
    get canvasSize() {
        const svg = document.querySelector('svg');
        ...
        if (box) {
            return new BoundingBox_1.BoundingBox(new Vector_1.Vector(box.x, box.y), new Vector_1.Vector(box.x + box.width, box.y + box.height));
        }
        return new BoundingBox_1.BoundingBox(Vector_1.Vector.NULL, Vector_1.Vector.NULL);
    }
    initialize(network) {
    ...
    mirrorElement(element, network) {
        if (element.localName == 'path' && element.dataset.line != undefined) {
            return new Line_1.Line(new SvgLine_1.SvgLine(element), network, Config_1.Config.default);
        }
        else if (element.localName == 'path' && element.dataset.train != undefined) {
            return new Train_1.Train(new SvgTrain_1.SvgTrain(element), network, Config_1.Config.default);
        }
        else if (element.localName == 'rect' && element.dataset.station != undefined) {
            return new Station_1.Station(new SvgStation_1.SvgStation(element));
        }
        else if (element.localName == 'text' && (element.dataset.station != undefined || element.dataset.line != undefined)) {
            return new Label_1.Label(new SvgLabel_1.SvgLabel(element), network);
        }
        else if (element.localName == 'image' && element.dataset.zoom != undefined) {
            return new KenImage_1.KenImage(new SvgKenImage_1.SvgKenImage(element));
        }
        else if (element.localName == 'foreignObject' && element.dataset.crumpledImage != undefined) {
            return new CrumpledImage_1.CrumpledImage(new SvgCrumpledImage_1.SvgCrumpledImage(element));
        }
        else if (element.dataset.from != undefined || element.dataset.to != undefined) {
            return new GenericTimedDrawable_1.GenericTimedDrawable(new SvgGenericTimedDrawable_1.SvgGenericTimedDrawable(element));
        }
        return null;
    }
    createVirtualStop(id, baseCoords, rotation) {
        ...
        return new Station_1.Station(new SvgStation_1.SvgStation(helpStop));
    }
    setCoord(element, coord) {
        element.setAttribute('x', coord.x);
        element.setAttribute('y', coord.y);
    ...
    zoomTo(zoomCenter, zoomScale, animationDurationSeconds) {
        const animator = new SvgAnimator_1.SvgAnimator();
        const defaultBehaviour = animationDurationSeconds <= Config_1.Config.default.zoomDuration;
        animator.wait(defaultBehaviour ? 0 : Config_1.Config.default.zoomDuration * 1000, () => {
            const currentZoomCenter = this.currentZoomCenter;
            const currentZoomScale = this.currentZoomScale;
            animator
                .ease(defaultBehaviour ? SvgAnimator_1.SvgAnimator.EASE_CUBIC : SvgAnimator_1.SvgAnimator.EASE_NONE)
...
class SvgStation extends SvgAbstractTimedDrawable_1.SvgAbstractTimedDrawable {
    ...
    get baseCoords() {
        return new Vector_1.Vector(parseFloat(this.element.getAttribute('x') || '') || 0, parseFloat(this.element.getAttribute('y') || '') || 0);
    }
    set baseCoords(baseCoords) {
    ...
    get lonLat() {
        ...
        if (str == undefined)
            return undefined;
        return new Vector_1.Vector(parseFloat(str[0]), parseFloat(str[1]));
    }
    get rotation() {
        return Rotation_1.Rotation.from(this.element.dataset.dir || 'n');
    }
    /**
     * öasdfkljsdfklj
     */
    get labelDir() {
        return Rotation_1.Rotation.from(this.element.dataset.labelDir || 'n');
    }
    draw(delaySeconds, getPositionBoundaries) {
        ...
        animator.wait(delaySeconds * 1000, () => {
            ...
            this.element.setAttribute('width', (Math.max(stopDimen[0], 0) * Config_1.Config.default.lineDistance + Config_1.Config.default.defaultStationDimen) + '');
            this.element.setAttribute('height', (Math.max(stopDimen[1], 0) * Config_1.Config.default.lineDistance + Config_1.Config.default.defaultStationDimen) + '');
            this.updateTransformOrigin();
            const x = Math.min(positionBoundaries.x[0], 0) * Config_1.Config.default.lineDistance - Config_1.Config.default.defaultStationDimen / 2;
            const y = Math.min(positionBoundaries.y[0], 0) * Config_1.Config.default.lineDistance - Config_1.Config.default.defaultStationDimen / 2;
...
class SvgTrain extends SvgAbstractTimedDrawable_1.SvgAbstractTimedDrawable {
    ...
    move(delaySeconds, animationDurationSeconds, follow) {
        ...
        animator.wait(delaySeconds * 1000, () => {
            ...
            animator
                .ease(SvgAnimator_1.SvgAnimator.EASE_SINE)
    ...
    getPositionByLength(current, path) {
        ...
        for (let i = 0; i < path.length - 1; i++) {
            ...
            if (thresh + l >= current) {
                return path[i].between(path[i + 1], (current - thresh) / l).add(delta.rotate(new Rotation_1.Rotation(90)).withLength(Config_1.Config.default.trainTrackOffset));
            }
            thresh += l;
        }
    ...
    calcTrainHinges(front, path) {
        ...
        for (let i = 0; i < this.length + 1; i++) {
            newTrain.push(this.getPositionByLength(front - i * Config_1.Config.default.trainWagonLength, path));
        }
        return newTrain;
    }
...
class SvgUtils {
    ...
    static readTermini(terminiString) {
        ...
        if (numbers != undefined) {
            return [
                new Vector_1.Vector(parseFloat(numbers[1]), parseFloat(numbers[2])),
                new Vector_1.Vector(parseFloat(numbers[numbers.length - 2]), parseFloat(numbers[numbers.length - 1]))
            ];
        }
        return [];
    }
