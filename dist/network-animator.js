...
class CrumpledImage extends AbstractTimedDrawable_1.AbstractTimedDrawable {
    ...
    initialize(stations) {
        ...
        const delaunay = delaunator_1.default.from(this.vertices, n => n.startCoords.x, n => n.startCoords.y);
    ...
    setTrianglesExtendedToCanvasBoundaries(triangles, halfEdges) {
        const single = [];
    ...
    getCanvasSides() {
        ...
        const t = new Vector_1.Vector(br.x - tl.x, 0);
        const r = new Vector_1.Vector(0, tl.y - br.y);
        const b = new Vector_1.Vector(tl.x - br.x, 0);
        const l = new Vector_1.Vector(0, br.y - tl.y);
        return [
            { corner: tl, side: t },
            { corner: br, side: r },
            { corner: br, side: b },
    ...
    crumple(delay, animationDurationSeconds) {
        this.adapter.draw(delay, animationDurationSeconds, this.triangles.map(t => ({ src: [t.a.startCoords, t.b.startCoords, t.c.startCoords], dst: [t.a.station, t.b.station, t.c.station] })));
        return 0;
    }
...
class SvgCrumpledImage extends SvgAbstractTimedDrawable_1.SvgAbstractTimedDrawable {
    ...
    draw(delaySeconds, animationDurationSeconds, vertices) {
        const animator = new SvgAnimator_1.SvgAnimator();
