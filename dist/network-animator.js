...
class Gravitator {
    ...
    setCrumpledImage(crumpledImage) {
...
class Network {
    constructor(adapter, drawableSorter) {
        ...
        this.lineGroups = {};
        this.drawableBuffer = [];
        this.gravitator = new Gravitator_1.Gravitator(this);
...
let timePassed = 0;
const network = new Network_1.Network(new SvgNetwork_1.SvgNetwork(), new DrawableSorter_1.DrawableSorter());
let started = false;
let stopped = false;
