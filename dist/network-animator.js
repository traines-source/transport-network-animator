...
class Projection {
     ...
     */
    project(coords) {
        return Projection.projections[this._projection](coords).scale(_Config__WEBPACK_IMPORTED_MODULE_0__.Config["default"].mapProjectionScale).round(1);
    }
}
/**
...
Projection.projections = {
    'epsg3857': lonlat => new _Vector__WEBPACK_IMPORTED_MODULE_1__.Vector(256 / Math.PI * (lonlat.x / 180 * Math.PI + Math.PI), 256 / Math.PI * (Math.PI - Math.log(Math.tan(Math.PI / 4 + lonlat.y / 180 * Math.PI / 2))))
};
