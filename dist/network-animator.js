...
class GenericTimedDrawable extends AbstractTimedDrawable_1.AbstractTimedDrawable {
    ...
    draw(delay, animate) {
        this.adapter.draw(delay, animate ? Config_1.Config.default.fadeDurationSeconds : 0);
        return 0;
    }
    erase(delay, animate, reverse) {
        this.adapter.erase(delay, animate ? Config_1.Config.default.fadeDurationSeconds : 0);
        return 0;
    }
}
...
class Label extends AbstractTimedDrawable_1.AbstractTimedDrawable {
    ...
    draw(delay, animate) {
        const animationDurationSeconds = animate ? Config_1.Config.default.fadeDurationSeconds : 0;
        if (this.adapter.forStation != undefined) {
            ...
            this.adapter.draw(delay, animationDurationSeconds, Vector_1.Vector.NULL, Rotation_1.Rotation.from('n'), []);
        }
        return 0;
    }
    drawForStation(delaySeconds, animationDurationSeconds, station, forLine) {
...
class Station extends AbstractTimedDrawable_1.AbstractTimedDrawable {
    ...
    draw(delaySeconds, animate) {
        ...
        this.adapter.draw(delaySeconds, animate ? Config_1.Config.default.fadeDurationSeconds : 0, function () { return t; });
        return 0;
    }
    ...
    erase(delaySeconds, animate) {
        this.adapter.erase(delaySeconds, animate ? Config_1.Config.default.fadeDurationSeconds : 0);
        return 0;
    }
...
class SvgAbstractTimedDrawable {
    ...
    show(fadeSeconds) {
        if (fadeSeconds == 0) {
            ...
            this.element.style.visibility = 'visible';
            const animator = new SvgAnimator_1.SvgAnimator();
            animator.ease(Animator_1.Animator.EASE_CUBIC).animate(fadeSeconds * 1000, (x, isLast) => {
    ...
    hide(fadeSeconds) {
        if (fadeSeconds != 0) {
            ...
            const animator = new SvgAnimator_1.SvgAnimator();
            animator.ease(Animator_1.Animator.EASE_CUBIC).from(1).to(0).animate(fadeSeconds * 1000, (x, isLast) => {
                this.element.style.opacity = x + '';
                if (isLast) {
...
class SvgGenericTimedDrawable extends SvgAbstractTimedDrawable_1.SvgAbstractTimedDrawable {
    ...
    erase(delaySeconds, animationDurationSeconds) {
        const animator = new SvgAnimator_1.SvgAnimator();
        animator.wait(delaySeconds * 1000, () => {
...
class SvgLabel extends SvgAbstractTimedDrawable_1.SvgAbstractTimedDrawable {
    ...
    draw(delaySeconds, animationDurationSeconds, textCoords, labelDir, children) {
        const animator = new SvgAnimator_1.SvgAnimator();
        animator.wait(delaySeconds * 1000, () => {
    ...
    translate(animationDurationSeconds, boxDimen, labelDir) {
    ...
    drawLineLabels(animationDurationSeconds, labelDir, children) {
        ...
        this.translate(animationDurationSeconds, new Vector_1.Vector(bbox.width / scale, bbox.height / scale), labelDir);
    }
    drawLineLabel(label) {
    ...
    drawStationLabel(animationDurationSeconds, labelDir) {
        ...
        this.translate(animationDurationSeconds, new Vector_1.Vector(this.element.getBBox().width, this.element.getBBox().height), labelDir);
    }
    erase(delaySeconds, animationDurationSeconds) {
        const animator = new SvgAnimator_1.SvgAnimator();
        animator.wait(delaySeconds * 1000, () => {
    ...
    cloneForStation(stationId) {
        ...
        (_a = this.element.parentElement) === null || _a === void 0 ? void 0 : _a.appendChild(lineLabel);
...
class SvgNetwork {
    ...
    createVirtualStop(id, baseCoords, rotation) {
        ...
        (_a = this.parent) === null || _a === void 0 ? void 0 : _a.appendChild(helpStop);
...
class SvgStation extends SvgAbstractTimedDrawable_1.SvgAbstractTimedDrawable {
    ...
    draw(delaySeconds, animationDurationSeconds, getPositionBoundaries) {
        const animator = new SvgAnimator_1.SvgAnimator();
        animator.wait(delaySeconds * 1000, () => {
...
class SvgTrain extends SvgAbstractTimedDrawable_1.SvgAbstractTimedDrawable {
    ...
    move(delaySeconds, animationDurationSeconds, follow) {
        const animator = new SvgAnimator_1.SvgAnimator();
        animator.wait(delaySeconds * 1000, () => {
            this.show(animationDurationSeconds != 0 ? Config_1.Config.default.fadeDurationSeconds : 0);
    ...
    animateFrame(x, isLast, path, animationDurationSeconds) {
        const trainPath = this.calcTrainHinges(x, path);
        this.setPath(trainPath);
        if (isLast && this.from.flag.includes('autoshow')) {
            this.hide(animationDurationSeconds != 0 ? Config_1.Config.default.fadeDurationSeconds : 0);
        }
        return true;
    }
}
...
/******/ })()
;
//# sourceMappingURL=network-animator.js.map