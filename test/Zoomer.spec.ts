...
describe('Zoomer', () => {
    ...
    it('whenInclude_givenValidBoxes', () => {        
        ...
        z.include({tl: new Vector(100, 200), br: new Vector(300, 600)}, new Instant(1, 1, ''), true);
    ...
    it('whenInclude_givenInvalidBoxesYAxis', () => {        
        ...
        z.include({tl: new Vector(100, 200), br: new Vector(200, 200)}, new Instant(1, 1, ''), true);
        expect(z.center).eql(new Vector(150, 200));
        expect(z.scale).eql(3);

        z.include({tl: new Vector(300, 200), br: new Vector(300, 600)}, new Instant(1, 1, ''), true);
        expect(z.center).eql(new Vector(200, 400));
        expect(z.scale).eql(2);
    })
